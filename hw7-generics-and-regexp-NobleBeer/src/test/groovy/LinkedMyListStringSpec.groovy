...
class LinkedMyListStringSpec extends Specification {

        def "1: check empty size array"() {
            given:
            MyList<String> myList = new LinkedMyList<>()
        ...
        def "7: check insert method"() {
            ...
            then:
            myList.toArray(new String[0]) == ["2", "10", "3", "4"]
        }
        ...
        def "8: check insert method"() {
            ...
            then:
            myList.toArray(new String[0]) == ["10", "2", "3", "4"]
        }
        ...
        def "8: check delete method"() {
            ...
            then:
            myList.toArray(new String[0]) == ["2", "3", "4"]
        }
        ...
        def "9: check delete method"() {
            ...
            then:
            myList.toArray(new String[0]) == ["1", "2", "3"]
        }
        ...
        def "10: check add first method"() {
            ...
            then:
            myList.toArray(new String[0]) == ["13", "1", "2", "3", "4"]
        }
}
